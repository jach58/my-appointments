        ...
        <div class="form-group">
          ...
          <div class="input-group input-group-alternative">
            ...
            <input type="text" class="form-control datepicker" placeholder="Seleccionar fecha"
              id="date" name="scheduled_date" value="{{ old('scheduled_date', date('Y-m-d') )}}" data-date-format="yyyy-mm-dd"
          ...
          <div id="hours">
            ...
            @else
              <div class="alert alert-info" role="alert">
                Seleciona un médico y una fecha para ver sus horas disponibles.
              </div>
            @endif
          </div>
        </div>
